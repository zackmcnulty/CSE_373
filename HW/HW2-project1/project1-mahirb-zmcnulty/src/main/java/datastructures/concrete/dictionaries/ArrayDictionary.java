...
public class ArrayDictionary<K, V> implements IDictionary<K, V> {
    ...
    // and throws NoSuchKeyException if no such pair exists.
    private int getIndex(K key) throws NoSuchKeyException {
        ...
        // If we have parsed through the whole dictionary without finding the proper key,
        // no such key exists.
    ...
    public V remove(K key) throws NoSuchKeyException{        
        int index = this.getIndex(key); // throws NoSuchKeyException if no key matches
