...
public class AstNode {
    ...
    public AstNode(String name, AstNode child) {
        this.name = name;
        this.type = ExprType.OPERATION;
        IList<AstNode> cn = new DoubleLinkedList<>();
        cn.add(child);
        this.children = cn;
    }
    
    public AstNode(String name, AstNode child1, AstNode child2) {
        this.name = name;
        this.type = ExprType.OPERATION;
        IList<AstNode> cn = new DoubleLinkedList<>();
        cn.add(child1);
